...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description:
      "1968年前後に生まれた学年の「1968.LOVE」、ベータテスター30名募集中。創設メンバー限定 8 特典。",
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        a: "申し訳ございません、本サービスはご本人が対象の学年（1967年4月2日〜1970年4月1日生まれ）の場合のみご利用いただけます。代理での申し込みはご遠慮ください。",
      },
      {
        q: "応募すれば必ず参加できますか？",
...
const BENEFITS: Array<{ emoji: string; title: string; desc: string }> = [
  ...
  },
  {
    ...
    desc: "「1968年前後生まれが語る昭和」など、コミュニティから生まれる出版物が完成した際に、創設メンバーへ進呈する予定です。",
  },
  {
    emoji: "✍",
