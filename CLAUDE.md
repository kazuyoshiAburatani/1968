...
| 日 | 年代 | 二択 | お題 | 記事 |
| --- | --- | --- | --- | --- |
| 8月10日（月） | 小学校のころ | 16問 | 9題 | 1本 |
| 8月17日（月） | 中学のころ | 20問 | 18題 | 1本 |
| 8月24日（月） | 高校のころ | 16問 | 21題 | 1本 |
| 8月31日（月） | 二十代のころ | 8問 | 12題 | — |

初日に全部出すと「今週の二択」という毎週来る理由が消え、週 2 問ずつだと初日の
一覧が空いて見える。年代でまとめると、初日から一覧が埋まったうえに次も待てる。

同じ年代のものは秒単位で時刻をずらしてある。寸分同じ時刻にすると、
ホームの「今週の二択」がどの 2 問になるか決まらないため。先頭ほど新しい。

下書きの 20 問（`is_active = false`、公開日 2099年）はこの予定に乗せていない。
出すと決めたら、管理画面で日付を入れて有効にする。

**8月31日で在庫が尽きる。** それ以降も続けるなら、下書き 20 問を出すか、
新しい問いを足すこと。`/admin/polls` は配信待ちが 4 件を切ると警告を出す。
